...
class Kriging:
    ...
    def __init__(self,x,y,kernel,theta0="",optimizer="COBYLA",optimizer_noise=1.0,eps=1.48e-08,restarts=1,preprocessing="standardize"):
        ...
        self.theta0 = theta0
        self.likelihood = 0
        self.likelihood_threshold = 0.05 #hack to ensure good values # former value = 1
    ...
    def get_new_initial_points(self):
        ...
        for i in range(self.Nk): # theta part
            ...
            # new_start_point.append(np.random.uniform(1e-3,1e3)) #trying to fix negative likelihood
