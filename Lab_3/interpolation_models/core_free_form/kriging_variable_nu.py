...
class Kriging:
    ...
    def get_theta(self, theta0, nu0):
        ...
        while(self.likelihood < self.likelihood_threshold): # continue HO till a reasonable result is obtained
            ...
            if (self.optimizer=="CMA-ES"):
                ...
                res = minimize(self.NLL,xk,constraints=[{"fun": con, "type": "ineq"} for con in constraints],
                            method=self.optimizer,options={"rhobeg": _rhobeg, "tol": 1e-20, "maxiter": 1e7})
