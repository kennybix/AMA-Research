...
from sampling_algorithm import halton_sequence as hs
from sampling_algorithm import lhs 
...
class Sampling_plan():
    ...
    def create_samples(self):
        ...
        elif self.sequence == 'lhs':
            x_hs = lhs.sample(self.Nk,self.Ns) #not tested
        x_hs = x_hs.T
