...
class Kriging:
    ...
    def __init__(self,x,y,kernels,theta0="",weights0="",optimizer="CMA-ES",optimizer_noise=1.0,eps=1.48e-08,restarts=1,preprocessing="normalize"):
    ...
    def get_theta(self,hyperparameter):
        ...
        self.likelihood = -float(self.NLL(optimal_hyperparameter))
