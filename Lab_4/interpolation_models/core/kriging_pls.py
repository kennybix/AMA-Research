...
class Kriging:
    ...
    def __init__(self,x,y,kernel,theta0="",optimizer="nelder-mead-c",optimizer_noise=1.0,eps=1.48e-08,restarts=1,preprocessing="normalize",pls_n_comp="", pls_cv=5):
        ...
        if self.kernel == "matern":
            self.theta0 = [0.5] + [0.01]*self.pls_n_comp
        else:
