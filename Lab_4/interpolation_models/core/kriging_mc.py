...
import pymc3 as pm #MCMC library
'''
Improvements:
...
class Kriging:
    ...
    def __init__(self,x,y,kernel,theta0="",optimizer="CMA-ES",optimizer_noise=1.0,eps=1.48e-08,restarts=1,preprocessing="normalize"):
        ...
        if theta0 == "": #handle it in-house
            theta0 = [0.01]*self.Nk
        else:
            theta0 = theta0

        if self.kernel == "matern":
            self.theta0 = [0.5] + theta0
        else:
            self.theta0 = theta0
    ...
    def get_theta(self,theta0):
        ...
        with basic_model:
            ...
            nll_function = self.NLL(theta)
            nll = pm.Normal("nll",mu=nll_function)
