...
class active_learn():
    def __init__(self,whole_data,initial_ns,stopping_criteria=0.3,max_steps=1000,DOE="LHS",kernel="gaussian",tolerance=1e-4):
        ...
        self.x_data = self.whole_data["x_data"]
        self.y_data = self.whole_data["y_data"]        
    ...
    def get_more_samples(self):
        ...
        while(count<self.max_steps): #stopping criteria
            ...
            self.gp_old = KCORE2.Kriging(x_sample,y_sample,self.kernel,theta0=theta0,optimizer="COBYLA") #initialiize model
