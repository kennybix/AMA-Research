...
class active_learn():
    ...
    def get_more_samples(self):
        ...
        maximum_improvement_list = [24,0.0001,1000,221] #random numbers with large variance
        ...
        while(count<self.max_steps): #stopping criteria
            ...
            model_prediction = (self.model.predict(pooled_data))[0]
            model_variance = self.model.predict_variance(pooled_data) #compute model variance
            scaled_model_variance = self.model.y_scaler.transform(model_variance)
