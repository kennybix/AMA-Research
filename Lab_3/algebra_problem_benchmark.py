...
#     limits = [[-2,2]]*2
#     model = adsp.active_learn(BP.camelBack,limits,params['initial_ns'],params['stopping_criterion_value'],params['max_iter'])
#     start_time = time.time()
...
#     limits = [[-5,5]]*2
#     model = adsp.active_learn(BP.himmelblau,limits,params['initial_ns'],params['stopping_criterion_value'],params['max_iter'])
#     start_time = time.time()
#     x,f = model.get_more_samples()
#     elapsed_time = time.time() - start_time
#     info = "Learning time with "+str(params['stopping_criterion_value'])+" :"+str(elapsed_time)
...
def branin_2D(params):
    limits = [[-5,10],[0,15]]
    model = adsp.active_learn(BP.branin_2D,limits,params['initial_ns'],params['stopping_criterion_value'],params['max_iter'])
    start_time = time.time()
    x,f = model.get_more_samples()
    elapsed_time = time.time() - start_time
    info = "Learning time with "+str(params['stopping_criterion_value'])+" :"+str(elapsed_time)
...
#     limits = [[-5,5]]*2
#     model = adsp.active_learn(BP.Ackley,limits,params['initial_ns'],params['stopping_criterion_value'],params['max_iter'])
#     start_time = time.time()
#     x,f = model.get_more_samples()
#     elapsed_time = time.time() - start_time
#     info = "Learning time with "+str(params['stopping_criterion_value'])+" :"+str(elapsed_time)
...
# @register_for_training
# def multiModal2D(params):
#     limits = [[-2,2]]*2
#     model = adsp.active_learn(BP.multiModal2D,limits,params['initial_ns'],params['stopping_criterion_value'],params['max_iter'])
#     x,f = model.get_more_samples()
#     return f,x
...
# @register_for_training
# def goldsteinPrice(params):
#     limits = [[-2,2]]*2
#     model = adsp.active_learn(BP.goldsteinPrice,limits,params['initial_ns'],params['stopping_criterion_value'],params['max_iter'])
#     x,f = model.get_more_samples()
#     return f,x
...
# @register
# def goldsteinPrice(TEST_SIZE):
#     limits = [[-2,2]]*2
#     x = (np.random.rand(TEST_SIZE,len(limits))) #generate random samples for testing
#     x = SC.scale(x,limits)
#     f = BP.goldsteinPrice(x) 
#     return f,x
